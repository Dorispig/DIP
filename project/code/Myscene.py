...
import pyrender
class Myscene:
    def __init__(self,tri_mesh= None,pyrender_mesh= None,init_pyrender_mesh=None,camera_node= None,camera_pose= None,
        ...
        self.init_pyrender_mesh = init_pyrender_mesh
